...
적용되어지고 있지 않음
- 2023년 9월 기준, 상용화된 앱들은 한가지 운동만을 지원, 한 방향에서만 서비스 지원되는 것으로 파악
- checkmate의 서비스는 운동 분류 서비스를 지원함으로
 ..( 우리 기술이 다른 기술보다 장점인 부분 어필하기)다른 app들은 한가지운동만 지원, 한 각도에서만 지원 등등을 설명하며 우리서비스는 여러각도에서 찍어도 가능 총 5가지의 운동을 지원한다는 점을 어필할 것,
